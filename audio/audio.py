...
shuffle_audio_blocks("CantinaBand3.wav", sudoku_board)
...
fs_orig, original_audio = wavfile.read('CantinaBand3.wav')
fs_shuffled, shuffled_audio = wavfile.read('encrypted_audio.wav')
